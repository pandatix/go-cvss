<div align="center">
	...
	<a href="https://www.bestpractices.dev/en/projects/7519"><img src="https://img.shields.io/cii/summary/7519?style=for-the-badge&label=openssf%20best%20practices" alt="OpenSSF Best Practices Summary"></a>
</div>
...
The following are the results of the comparison with others Go CVSS implementations, based on our [benchmarking suite](./benchmarks).
Results and graphs have been automatically generated by our [`plot`](https://github.com/pandatix/go-cvss/blob/main/benchmarks/cmd/plot/main.go) tool, from [a GitHub Action manual dispatch](https://github.com/pandatix/go-cvss/actions/workflows/benchmarks.yaml).

For each metric (`ns/op`, `B/op`, `allocs/op`), the bar height is computed as the log of a given metric for a benchmark workflow, in a CVSS version, for a given implementation, represented as the proportion (i.e. `%`) of the "worst" case (i.e. the implementation that performs the least on this metric)  with a `max(v,1)` used in the log scale for graph readability by avoiding negative values for small values (i.e. `0 < x < 1`).

This simplify comparisons and shows how well it performs: the lower, the better (don't forget it's a log scale, so a bit above means WAY ABOVE).

Benchmarks results for CVSS v2.
<div align="center">
	<img src="res/benchmark-results-cvss-V2.svg">
</div>

Benchmarks results for CVSS v3.
<div align="center">
	<img src="res/benchmark-results-cvss-V3.svg">
</div>

Benchmarks results for CVSS v4.
<div align="center">
	<img src="res/benchmark-results-cvss-V4.svg">
</div>
